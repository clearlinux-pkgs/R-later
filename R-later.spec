...
Version  : 1.4.2
Release  : 57
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/later_1.4.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/later_1.4.2.tar.gz
...
%package dev
Summary: dev components for the R-later package.
Group: Development
Requires: R-later-lib = %{version}-%{release}
Provides: R-later-devel = %{version}-%{release}
Requires: R-later = %{version}-%{release}

%description dev
dev components for the R-later package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744161198
...
/usr/lib64/R/library/later/tests/testthat/test-later-fd.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/later/libs/later.so
/V4/usr/lib64/R/library/later/libs/later.so
