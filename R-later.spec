...
Version  : 1.1.0.1
Release  : 27
URL      : https://cran.r-project.org/src/contrib/later_1.1.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/later_1.1.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591375625
