...
Version  : 0.7.2
Release  : 1
URL      : https://cran.r-project.org/src/contrib/later_0.7.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/later_0.7.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526836164
